	...
	<view class="drag-box">
		<view 
			...
			@touchend="touchend(item)">
				<uni-icons type="checkbox" size="28" style="position: absolute;left: 10px;display: inline-block;line-height: 70px;color: #FF5500;"></uni-icons>
				<view style="padding: 13px 0;">
					<h1 style="font-size: 18px;margin: 0;">{{item[itemKey]}}</h1>
					<p style="font-size: 16px;margin: 0;">{{item[itemKey]}}</p>
				</view>
			</view>
	</view>
</template>
